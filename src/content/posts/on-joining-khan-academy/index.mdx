...
In October 2025, I started a new role as a Senior Engineer II at Khan Academy, a nonprofit education technology company. I work on our Wonder Blocks design system, accessibility, and tooling across the company and I love it!
...
3) My accountant also said we would be better off as a family with a W2 for our finances, especially for our healthcare. This ended up being pretty important.
...
So I started interviewing again, less than a year later. I got more big-deal interviews and saw behind the curtain at some really impressive companies, including Figma, Stripe, and Cisco Meraki. The coding interviews gave me insight into the interesting problems these companies were solving. I was still rejected a lot but the practice made me a better engineer.
...
There's a lot to like at Khan Academy: remote work, the pay is good (for a nonprofit), and the benefits are thoughtfully organized. We have focus Wednesdays with fewer meetings, occasional focus weeks, and periodic Wellness Days off throughout the year. There is a flexible, open PTO policy. Every 5 years, employees are encouraged to take a sabbatical (5 weeks for 5 years, 10 weeks for 10 years, etc.)

The dedication to pedagogy (the method and practice of teaching) is evident in our product development priorities, which I really appreciate. There is a lot of care taken to ensure the things we create have positive effects for learners across the world.

There are also some challenging parts. Being a nonprofit, we are often required to do more with less. There is always more work than we have time for. Our codebase is also quite large and complicated in places, so it can be difficult sometimes to make moves as a frontend infrastructure engineer. 

Lately, there has been a big push to adopt Artificial Intelligence (AI) in nearly everything we thing do. I have definitely benefitted from the productivity boost in areas that I didn't feel as strong in, but there's a tension. I don't think I would be as effective if I hadn't spent all that time hammering on code patterns and engineering without it -- I'm pretty sure I'd be lost. 

I also see a widening gulf, at least in my own ability to keep up with the industry, if I weren't in this seat building with AI every day. It would be hard to imagine what frontend engineering teams are currently doing if I wasn't also using these tools with real-world constraints. For example, we are thinking about best how to support people _and_ computers as consumers of our design system. Every few weeks feels like new territory. It's hard, but I'm still glad to be here.
